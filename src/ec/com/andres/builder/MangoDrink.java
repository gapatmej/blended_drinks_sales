...
public class MangoDrink extends DrinkBuilder {

	private static final BigDecimal amountFruitNecesary = new BigDecimal(140);
	private Size size;
	...
	@Override
	public void setName() {
		drink.setName(FlavorEnum.MANGO.getName());
	}
	...
	public static Flavor createFlavor() {
		...
		fruitIngredient = fruitIngredient.findByAtrribute("flavorEnum", FlavorEnum.MANGO.toString());
